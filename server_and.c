...
#include <arpa/inet.h>
#include <stdlib.h>
#define PORT 22714 /* server_or port number */
...
int main(){ 
    ...
    */
    ...
    while(1){
        ...
        int ret=recvfrom(s,buff[row],105,0,(struct sockaddr *)&client,&addr_len); // once success, we get client.
        if(ret==-1){
    ...
    while(1){}; /* keep server_and active */
    return 0;
